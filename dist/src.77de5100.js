...
function createSlider(selector) {
  ...
  if (!rootEl) {
    throw new Error("Slider root not found by ".concat(selector));
  }

  var slides = rootEl.querySelectorAll('.group__card');
  var pagination = rootEl.querySelectorAll('.pagination .dot');
  var pageIndicator = rootEl.querySelector('.pagination .panel');
  ...
  pagination.forEach(function (element, index) {
    element.addEventListener('click', function () {
      ...
      slidesContainer.style.transform = "translateX(-".concat(slides[0].clientWidth * index + 10 * index, "px)");
      pageIndicator.style.transform = "translateX(".concat(pagination[0].clientWidth * index + 8 * index, "px)");
    });
  });
}

var sliderSelectors = ['.recruitment__block', '.candidate__block', '.conclusion__block' // ....
];
