...
var updateInputEmptyClass = function updateInputEmptyClass(input) {
...
var mobileMenu = document.querySelector('.mobile__header__nav');
var menuButton = document.querySelectorAll('.burger__button');
console.log({
  mobileMenu: mobileMenu,
  menuButton: menuButton
});
menuButton.forEach(function (nav) {
